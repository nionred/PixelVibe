<div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          <div class="avatar"><img src="{{ asset('admincss/img/laboni.jpg') }}" alt="..." class="img-fluid rounded-circle"></div>
          <div class="title">
            <h1 class="h5">Laboni Rahman</h1>
            <p>Web Designer</p>
          </div>
        </div>
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Arts </a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    ...
                    <li><a href="{{url('v_pro')}}">Show Art</a></li>
